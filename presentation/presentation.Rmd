...
The dataset comes from \href{https://www.kaggle.com/datasets/imdevskp/nobel-prize}{\beamergotobutton{Kaggle}} and contains information on each person or organisation that has received a Nobel Prize between 1901 and 2019.

In the following work, we will graphically depict, among other things, what age characterises the Nobel Prize award winners by field, which country the Nobel laureates came from, and which research topics dominated each category.

# Visualization

## Characteristics of Nobel Prize winners
...
## Distribution of Nobel prizes by years and age
...
## Topics of the awarded research papers
